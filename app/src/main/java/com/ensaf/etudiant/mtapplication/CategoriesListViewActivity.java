...
import com.ensaf.etudiant.mtapplication.adapter.SubcategoryAdapter;

public class CategoriesListViewActivity extends ActionBarActivity implements
		OnItemClickListener {

	public static final String LIST_VIEW_CATEGORY_EXPANDABLES = "com.ensaf.etudiant.mtapplication.Expandables";
	public static final String LIST_VIEW_CATEGORY_DRAG_AND_DROP = "com.ensaf.etudiant.mtapplication.DragAndDrop";
	public static final String LIST_VIEW_CATEGORY_SWIPE_TO_DISSMISS = "com.ensaf.etudiant.mtapplication.SwipeToDissmiss";
	public static final String LIST_VIEW_CATEGORY_APPEARANCE_ANIMATIONS = "com.ensaf.etudiant.mtapplication.AppearanceAnimations";
	public static final String LIST_VIEW_CATEGORY_STICKY_HEADER = "com.ensaf.etudiant.mtapplication.StickyHeader";
	public static final String LIST_VIEW_CATEGORY_GOOGLE_CARDS = "com.ensaf.etudiant.mtapplication.GoogleCards";
	...
	private Intent getTravelCategoryIntent(String category) {
		...
		if (category.equals(LIST_VIEW_OPTION_EXPANDABLE)) {
			...
			intent = new Intent(this, GoogleCardsMonumentsActivity.class);
		}
		return intent;
	}
