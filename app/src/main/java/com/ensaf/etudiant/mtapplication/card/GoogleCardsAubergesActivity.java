...
public class GoogleCardsAubergesActivity extends ActionBarActivity implements
        OnDismissCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsTravelAdapter(this, DummyContent.getAubergesDummyList());
        ...
        getSupportActionBar().setTitle("MT Fés Auberges");
