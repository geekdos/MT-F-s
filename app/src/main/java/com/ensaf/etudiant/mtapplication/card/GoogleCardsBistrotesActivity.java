...
public class GoogleCardsBistrotesActivity extends ActionBarActivity implements
        OnDismissCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsTravelAdapter(this, DummyContent.getDummyBistrotList());
        ...
        getSupportActionBar().setTitle("MT Fés Bistrol");
