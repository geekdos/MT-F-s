...
public class GoogleCardsFastFoodActivity extends ActionBarActivity implements
        OnDismissCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsTravelAdapter(this, DummyContent.getFastFoodDummyList());
        ...
        getSupportActionBar().setTitle("MT Fés Fast Food");
