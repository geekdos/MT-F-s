...
public class GoogleCardsHistoriqueActivity extends ActionBarActivity implements
        OnDismissCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsTravelAdapter(this,
                DummyContent.getHistoriqueDummyList());
        ...
        getSupportActionBar().setTitle("MT Fés Historique");
    }
