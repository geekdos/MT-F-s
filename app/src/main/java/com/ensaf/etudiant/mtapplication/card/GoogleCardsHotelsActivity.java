...
public class GoogleCardsHotelsActivity extends ActionBarActivity implements
        OnDismissCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsTravelAdapter(this, DummyContent.getHotelsDummyList());
        ...
        getSupportActionBar().setTitle("MT Fés Hotéles");
