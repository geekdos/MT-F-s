...
public class GoogleCardsMonumentsActivity extends ActionBarActivity implements
		OnDismissCallback {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		mGoogleCardsAdapter = new GoogleCardsTravelAdapter(this, DummyContent.getMonumentsDummyList());
		...
		getSupportActionBar().setTitle("MT Fés Monuments");
