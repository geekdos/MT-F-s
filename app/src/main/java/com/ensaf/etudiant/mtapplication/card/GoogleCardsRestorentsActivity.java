...
public class GoogleCardsRestorentsActivity extends ActionBarActivity implements
        OnDismissCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsTravelAdapter(this, DummyContent.getRestorantsDummyList());
        ...
        getSupportActionBar().setTitle("MT Fés Reastorant Hotels");
