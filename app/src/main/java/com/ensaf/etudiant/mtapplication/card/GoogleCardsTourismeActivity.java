...
public class GoogleCardsTourismeActivity extends ActionBarActivity implements
        OnDismissCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsTravelAdapter(this,
                DummyContent.getTourismeDummyList());
        ...
        getSupportActionBar().setTitle("MT Fés Tourisme");
    }
