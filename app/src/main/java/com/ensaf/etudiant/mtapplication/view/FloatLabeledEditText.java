package com.ensaf.etudiant.mtapplication.view;
...
public class FloatLabeledEditText extends LinearLayout {
    ...
    private OnFocusChangeListener onFocusChanged = new OnFocusChangeListener() {
        ...
        public void onFocusChange(View view, boolean gotFocus) {
            if (gotFocus) {
                com.nineoldandroids.animation.ObjectAnimator.ofFloat(hintTextView, "alpha", 0.33f, 1f).start();
            } else {
                com.nineoldandroids.animation.ObjectAnimator.ofFloat(hintTextView, "alpha", 1f, 0.33f).start();
            }
        }
    };
    ...
    private void setShowHint(final boolean show) {
        ...
        if ((hintTextView.getVisibility() == VISIBLE) && !show) {
            android.animation.ObjectAnimator move = android.animation.ObjectAnimator.ofFloat(hintTextView, "translationY", 0, hintTextView.getHeight() / 8);
            android.animation.ObjectAnimator fade = android.animation.ObjectAnimator.ofFloat(hintTextView, "alpha", 1, 0);
            animation.playTogether(move, fade);
        } else if ((hintTextView.getVisibility() != VISIBLE) && show) {
            android.animation.ObjectAnimator move = android.animation.ObjectAnimator.ofFloat(hintTextView, "translationY", hintTextView.getHeight() / 8, 0);
            android.animation.ObjectAnimator fade = android.animation.ObjectAnimator.ofFloat(hintTextView, "alpha", 0, 1);
            animation.playTogether(move, fade);
        }
